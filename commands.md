...
| !code `COMMAND`                   | View the source code for any command. Example: "`!code covid`".
| !coomer                           | Edited... <img src="https://cdn.frankerfacez.com/emoticon/208616/1" width="32" height="28">
| !covid `OPTIONAL_IF_SET: COUNTRY` | Get the COVID Stats for a specific country. <br /> <br /> <b>WITH YOUR OWN COUNTRY</b> <br /> If you would like to use your own country instead of specifying every time, use !setcountry `YOUR_COUNTRY`. Example: "`!setcountry canada`". This will make to so just saying "`!covid`" will tell you the data or the country you set. You can still search specific country's with a set country. <br /> <br /> <b>WITH A SPECIFIC COUNTRY</b> <br /> If you would like to check the COVID stats for a specific country instead of setting yours or you would just like to know, you can use "`!covid COUNTRY_HERE`". Example: "`!covid united states`" or "`!covid ireland`". This will work with and without a set country.
...
| !ping // !info                    | Get the latency, uptime, commands used, prefix and other info about the bot! <img src="https://cdn.7tv.app/emote/60537cea9d9e96000d244f19/1x">
...
| !setlocation                      | To use the "`!time`" command, you must first set your location. Example: "`!setlocation lasalle ontario`".
...
| !time `OPTIONAL: USER`            | Get the time of the location that you previously set. If you would like to check a user's timem use the: "`!time USERNAME_HERE`" command. Example: "`!time darkvypr`".
