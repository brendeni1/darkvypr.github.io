...
| !covid `OPTIONAL_IF_SET: COUNTRY` | Get the COVID Stats for a specific country. <br /> <br /> <b>WITH YOUR OWN COUNTRY</b> <br /> If you would like to use your own country instead of specifying every time, use !setlocation `YOUR_LOCATION`. Example: "`!setlocation lasalle ontario`", "`!setlocation springfield virginia`" or "`!setlocation stockholm sweden`". This will make it so just saying "`!covid`" will tell you the data for the location you set. You can still search specific countries with a set country. <br /> <br /> <b>WITH A SPECIFIC COUNTRY</b> <br /> If you would like to check the COVID stats for a specific country instead of setting yours or you would just like to know, you can use "`!covid COUNTRY_HERE`". Example: "`!covid united states`" or "`!covid ireland`". This will work with and without a set location.
